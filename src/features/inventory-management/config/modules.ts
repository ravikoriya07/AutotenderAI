...
export type InventoryModuleConfig = {
  ...
  href: `/inventory-management/${InventoryModuleSlug}`;
  label: string;
  description: string;
  icon: LucideIcon;
};
...
export const INVENTORY_MODULES: InventoryModuleConfig[] = [
  {
    ...
    href: "/inventory-management/project-details",
  ...
  },
  {
    ...
    href: "/inventory-management/contractor-database",
  ...
  },
  {
    ...
    href: "/inventory-management/chasing-tracking",
  ...
  },
  {
    ...
    href: "/inventory-management/quotation-storage",
  ...
  },
  {
    ...
    href: "/inventory-management/contractor-selection",
